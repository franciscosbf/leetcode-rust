/// Ugliest **** ever made (iterative version of Depth-First Search just takes too much memory
/// and time to manage allocations, deallocations, read/write accesses ...)
pub fn longest_increasing_path(matrix: Vec<Vec<i32>>) -> i32 {
    let mut lp = 1;
    let m = unsafe { matrix.first().unwrap_unchecked().len() };
    let n = matrix.len();
        ...
        (0..m).for_each(|bj| {
            ...
            while let Some((i, j, c)) = stack.pop() {
                ...
                match i.checked_sub(1) {
                    Some(ii) if matrix[ii][j] > v => stack.push((ii, j, c + 1)),
                    _ => (),
                }
                let ii = i + 1;
                if ii.lt(&n) && matrix[ii][j] > v {
                    stack.push((ii, j, c + 1));
                }
                match j.checked_sub(1) {
                    Some(jj) if matrix[i][jj] > v => stack.push((i, jj, c + 1)),
                    _ => (),
                }
                let jj = j + 1;
                if jj.lt(&m) && matrix[i][jj] > v {
                    stack.push((i, jj, c + 1));
                }
            }
        })
...
fn main() {
    ...
    println!(
        "{}",
        longest_increasing_path(vec![vec![4, 4, 5], vec![3, 2, 6], vec![2, 2, 1]])
    );
    println!("{}", longest_increasing_path(vec![vec![1]]));
    println!(
        "{}",
        longest_increasing_path(vec![
            vec![7, 6, 1, 1],
            vec![2, 7, 6, 0],
            vec![1, 3, 5, 1],
            vec![6, 6, 3, 2]
    ...
    println!(
        ...
        longest_increasing_path(vec![
            ...
            vec![
                455, 454, 453, 452, 451, 450, 449, 448, 447, 446, 445, 444, 443, 442, 441, 440,
                439, 438, 437, 436, 435, 434, 433, 432, 431, 430, 429, 428, 427, 426, 425, 424,
                423, 422, 421, 420, 419, 418
            ],
            vec![
            ...
            vec![
                531, 530, 529, 528, 527, 526, 525, 524, 523, 522, 521, 520, 519, 518, 517, 516,
            ...
            vec![
                683, 682, 681, 680, 679, 678, 677, 676, 675, 674, 673, 672, 671, 670, 669, 668,
                667, 666, 665, 664, 663, 662, 661, 660, 659, 658, 657, 656, 655, 654, 653, 652,
                651, 650, 649, 648, 647, 646
            ],
            vec![
            ...
            vec![
                759, 758, 757, 756, 755, 754, 753, 752, 751, 750, 749, 748, 747, 746, 745, 744,
            ...
            vec![
                835, 834, 833, 832, 831, 830, 829, 828, 827, 826, 825, 824, 823, 822, 821, 820,
            ...
            vec![
                987, 986, 985, 984, 983, 982, 981, 980, 979, 978, 977, 976, 975, 974, 973, 972,
                971, 970, 969, 968, 967, 966, 965, 964, 963, 962, 961, 960, 959, 958, 957, 956,
                955, 954, 953, 952, 951, 950
            ],
            vec![
            ...
            vec![
                1063, 1062, 1061, 1060, 1059, 1058, 1057, 1056, 1055, 1054, 1053, 1052, 1051, 1050,
                1049, 1048, 1047, 1046, 1045, 1044, 1043, 1042, 1041, 1040, 1039, 1038, 1037, 1036,
